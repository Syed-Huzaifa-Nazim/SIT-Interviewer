    ...
    <PublicLayout>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start">
          <Card className="md:col-span-2 p-6 space-y-6 border border-slate-200 dark:border-slate-800">
          ...
          <Card className="md:col-span-3 p-6 border border-slate-200 dark:border-slate-800">
