...
/**
 * Table primitives for the Admin Hub lists.
 *
 * The wrapper owns the horizontal scroll (`overflow-x-auto`) so a wide table scrolls
 * inside its own container instead of pushing the whole page sideways — the admin pages
 * carry 8-10 columns on a laptop screen.
 */
